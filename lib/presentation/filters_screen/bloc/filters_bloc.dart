...
import 'package:sanjay_s_application2/presentation/filters_screen/models/filters_model.dart';
part 'filters_event.dart';
part 'filters_state.dart';

/// A bloc that manages the state of a Filters according to the event that is dispatched to it.
class FiltersBloc extends Bloc<FiltersEvent, FiltersState> {
  FiltersBloc(FiltersState initialState) : super(initialState) {
    on<FiltersInitialEvent>(_onInitialize);
  ...
  _onInitialize(
    FiltersInitialEvent event,
    Emitter<FiltersState> emit,
  ) async {
    emit(state.copyWith(
        filtersModelObj: state.filtersModelObj?.copyWith(
